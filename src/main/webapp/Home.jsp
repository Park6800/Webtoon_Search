				...
				%>
					<form class="inline_b" method="post" action="loginServlet">
						<input type="text" class="w_text" placeholder="ID를 입력하세요"
							name="Id"> <input type="password" class="w_text"
							placeholder="PW를 입력하세요" name="Pw">
					...
					<div class="user">
						...
						<div class="user_img">
							...
							<div class="user_mid">
								<div class="mid"><a href="Logout.jsp">로그아웃</a></div>
	...
	<div class="genre">
		...
		<div class="genres">
			...
			<div class="imgs" name="Romance_Fantasy">
				<div class="genre_"
					onclick="select_genre('Romance_Fantasy'); change_sel('로맨스 판타지');"
			...
			<div class="imgs" name="Action">
				<div class="genre_"
					onclick="select_genre('Action'); change_sel('액션');" id="Action">
					무협</div>
			</div>
			<div class="imgs" name="Comic">
				<div class="genre_"
					onclick="select_genre('Comic'); change_sel('코믹');" id="Comic">
					개그</div>
			</div>
		</div>
	</div>
